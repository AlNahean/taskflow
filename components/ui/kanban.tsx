// File: E:/projects/sorties/task-management/task-manager-app/components/ui/kanban.tsx
"use client";
        ...
        <KanbanColumnContext.Provider value={columnContext}>
            ...
            >
                <ColumnPrimitive
                    ...
                    style={composedStyle}
                    className={cn(
                        "flex size-full flex-col gap-2 rounded-lg border bg-muted/50 p-2.5 aria-disabled:pointer-events-none aria-disabled:opacity-50",
                        {
